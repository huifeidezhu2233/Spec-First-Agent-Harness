"""Workflow event and history management."""
import json
from pathlib import Path
from datetime import datetime
from typing import List, Dict, Any

from sfah.io_utils import read_text_file
...
class HistoryManager:
    ...
    def _read_events(self) -> List[Dict[str, Any]]:
        """读取事件列表"""
        return json.loads(read_text_file(self.events_file))
    ...
    def log_workflow_event(self, event: str, **details: Any):
        """记录通用工作流事件。"""
        payload = {
            "timestamp": datetime.now().isoformat(),
            "event": event,
