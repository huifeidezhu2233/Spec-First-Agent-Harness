...
import pytest
from sfah.models import Task, TaskStatus, Priority
from sfah.executor import ExecutionMode, select_execution_mode, ExecutionEngine
...
class TestWorkerAgent:
    ...
    def test_worker_agent_initializes(self):
        ...
        from sfah.executor import WorkerAgent
    ...
    def test_worker_agent_execute_task(self):
        ...
        from sfah.executor import WorkerAgent, ExecutionResult
...
class TestSoloExecutor:
    ...
    def test_solo_executor_initializes(self):
        ...
        from sfah.executor import SoloExecutor
...
class TestParallelExecutor:
    ...
    def test_parallel_executor_initializes(self):
        ...
        from sfah.executor import ParallelExecutor
...
class TestGitWorktreeManager:
    ...
    def test_git_worktree_manager_initializes(self):
        ...
        from sfah.git import GitWorktreeManager
...
class TestTaskExecutionService:
    ...
    def test_execution_result_to_dict(self):
        ...
        from sfah.executor import ExecutionResult
    ...
    def test_execution_engine_prepare_batches_empty(self):
        """RED: 测试准备执行批次 - 空任务列表"""
        from sfah.executor import ExecutionEngine
